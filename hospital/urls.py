...
urlpatterns = [
    ...
    path('checkup_report/<int:appointment_id>/', views.checkup_report, name='checkup_report'),
    path('download_checkup_report/<int:appointment_id>/', views.download_checkup_report, name='download_checkup_report'),
]